...
CREATE TABLE `member_access_right` (
  ...
  UNIQUE KEY `idxUMemberAccessRightMemberAction` (`member`,`action`) USING BTREE,
  KEY `idxNMemberAccessRightDateAssigned` (`date_assigned`) USING BTREE,
  KEY `idxNMemberAccessRightAction` (`action`) USING BTREE,
...
CREATE TABLE `member_group_access_right` (
  ...
  UNIQUE KEY `idxUMemberGroupAccessRightMemberGroupAction` (`member_group`,`action`) USING BTREE,
  KEY `idxNMemberGroupAccessRightAction` (`action`) USING BTREE,
